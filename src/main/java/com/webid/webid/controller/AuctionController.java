...
public class AuctionController {
    ...
    // || (auction.getCurrentBidderID() == 0 && bidAmount >=
    // auction.getCurrentBid()) // if there are no
    // // bidders, user can bid
    // || (auction.getBidIncrement() == 0 ? bidAmount > auction.getCurrentBid() //
    // logic for bidding with bid
    // // increment
